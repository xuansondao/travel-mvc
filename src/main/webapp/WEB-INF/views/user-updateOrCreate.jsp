                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-validation">
                                <form:form class="form-valide" action="/user" method="post" modelAttribute="userRequest">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="val-username" name="password" placeholder="Enter a username..">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="val-password" name="fullName" placeholder="Enter a username..">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="val-email" name="email" placeholder="Enter a username..">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="val-phone" name="phone" placeholder="Enter a username..">
                                        </div>
                                    </div>
                                    <c:forEach items="${roles}" var="role">
                                        <p>
                                            <input type="checkbox" class="check-box" name="ids" value="${role.id}"> ${role.name}
                                        </p>
                                    </c:forEach>
